...
CANONICAL_SCHEMA_VERSION = "2.0.2"
...
# ========================================================================
# DEPRECATION NOTE - v2.0.0 REFACTOR
# ========================================================================
# WorkoutTableStorage class has been removed as part of the ingestion schema refactor.
# Production code now uses StorageCoordinator and specialized storage classes:
#   - WorkoutStorage (workouts)
#   - PhysiometricsStorage (physiometrics)
#   - OAuthTokenStorage (oauth tokens)
#   - WebhookDedupStorage (webhook deduplication)
#   - AggregationStorage (aggregation data)
#
# See storage_coordinator.py for the new architecture.
# If legacy code still imports WorkoutTableStorage, update to:
#   from TrainingAnalyticsPlatform.storage.storage_coordinator import StorageCoordinator
#
# The IngestionContext class (above) is still used by both old and new storage layers
# for idempotency state management. It accepts any storage object with get_ingestion_state().
