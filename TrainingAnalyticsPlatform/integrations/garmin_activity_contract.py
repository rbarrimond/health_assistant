...
class GarminActivityContract:
    ...
    _COMMON_OPTIONAL_ALIASES: ClassVar[Dict[str, AliasPaths]] = {
        ...
        "aerobic_training_effect_message": (("aerobicTrainingEffectMessage",),),
        "anaerobic_training_effect_message": (("anaerobicTrainingEffectMessage",),),
        "vo2max_value": (("vO2MaxValue",),),
        "average_biking_cadence_rpm": (("averageBikingCadenceInRevPerMinute",),),
        "max_biking_cadence_rpm": (("maxBikingCadenceInRevPerMinute",),),
        "avg_left_balance_pct": (("avgLeftBalance",),),
        "average_running_cadence_spm": (("averageRunningCadenceInStepsPerMinute",),),
        "max_running_cadence_spm": (("maxRunningCadenceInStepsPerMinute",),),
        "avg_respiration_rate_brpm": (("avgRespirationRate",),),
        "max_respiration_rate_brpm": (("maxRespirationRate",),),
        "min_respiration_rate_brpm": (("minRespirationRate",),),
    ...
    _SOURCE_KEY_BY_FIELD: ClassVar[Dict[str, str]] = {
        ...
        "activity_training_load": "source_activity_training_load",
        "aerobic_training_effect": "source_aerobic_training_effect",
        "anaerobic_training_effect": "source_anaerobic_training_effect",
        "training_effect_label": "source_training_effect_label",
        "aerobic_training_effect_message": "source_aerobic_training_effect_message",
        "anaerobic_training_effect_message": "source_anaerobic_training_effect_message",
        "vo2max_value": "source_vo2max_value",
        "average_biking_cadence_rpm": "source_avg_biking_cadence_rpm",
        "max_biking_cadence_rpm": "source_max_biking_cadence_rpm",
        "avg_left_balance_pct": "source_avg_left_balance_pct",
        "average_running_cadence_spm": "source_avg_running_cadence_spm",
        "max_running_cadence_spm": "source_max_running_cadence_spm",
        "avg_respiration_rate_brpm": "source_avg_respiration_rate_brpm",
        "max_respiration_rate_brpm": "source_max_respiration_rate_brpm",
        "min_respiration_rate_brpm": "source_min_respiration_rate_brpm",
        "max_temperature_c": "source_max_temperature_c",
        "min_temperature_c": "source_min_temperature_c",
    }
