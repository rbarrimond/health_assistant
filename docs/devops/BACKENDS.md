...
| [wellness_sync.py](../../TrainingAnalyticsPlatform/handlers/wellness_sync.py) | Canonical Withings OAuth and webhook implementation ownership |
| [withings_handler.py](../../TrainingAnalyticsPlatform/handlers/withings_handler.py) | Backward-compatible shim preserving legacy imports and logger patch targets |
...
| [wellness_sync.py](../../TrainingAnalyticsPlatform/handlers/wellness_sync.py) | Canonical Garmin physiometrics sync implementation, raw payload archival, and wellness endpoint ownership |
| [garmin_physiometrics_sync_handler.py](../../TrainingAnalyticsPlatform/handlers/garmin_physiometrics_sync_handler.py) | Backward-compatible shim preserving legacy import and test patch paths |
