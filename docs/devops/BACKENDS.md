...
| [wellness_sync.py](../../TrainingAnalyticsPlatform/handlers/wellness_sync.py) | Canonical Withings webhook and sync orchestration implementation |
...
| [wellness_sync.py](../../TrainingAnalyticsPlatform/handlers/wellness_sync.py) | Canonical Garmin physiometrics sync implementation and endpoint ownership |
