...
- HR samples outside configured zone bounds are edge-clamped for classification (below floor → Z1, above ceiling → Z5) so all valid HR samples contribute to `hr_zone_total_sec`.
