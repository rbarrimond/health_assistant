...
> **Document role:** Memory architecture and API reference only.
> This file does not define normative agent behavior rules; behavior authority lives in [INSTRUCTIONS.md](./INSTRUCTIONS.md).
